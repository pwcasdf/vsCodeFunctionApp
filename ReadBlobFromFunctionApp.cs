...
{
    public static class ReadBlobFromFunctionApp
    {
        [FunctionName("ReadBlobFromFunctionApp")]
        public static async void Run([ServiceBusTrigger("c2dreadblobqueue", Connection = "ohcsbq_SERVICEBUS")]string myQueueItem, ILogger log)
        {
            string connectionStringIoTHub = "IOTHUB_CONNECTIONSTRING";
            string connectionStringSA = "STORAGEACCOUNT_CONNECTIONSTRING";
